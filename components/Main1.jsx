    ...
    <>
      <div className="h-[100%]  w-full flex flex-col rounded-[16px] p-[24px] gap-[54px] bg-[#0E0F11]  justify-center mt-[68px]  ">
        ...
        <div className="max-w-[786px] w-full mx-auto  flex flex-row items-center justify-between rounded-[12px] py-[12px] pr-[12px] pl-[24px] bg-[#1C1D1F]">
          <p className="font-[satoshi] font-[500] text-[14px] leading-[1.5] tracking-[0.02em] text-[#A3A3A3]">
            Write a prompt or click generate to continue
          </p>
          <div className="flex flex-row items-center gap-[4px] py-[4px] px-[12px] rounded-[8px] bg-[#00FF00] cursor-pointer">
            <p className="font-[clashGrotesk] font-[500] text-[16px] leading-[150%] tracking-[0.02em] text-black ">
              Generate
            </p>
            <img
